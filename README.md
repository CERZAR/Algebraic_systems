 ...
 **Содержание:**
 - [Решение сравнения $ax \equiv b (\text{mod} , c)$](#item-1)
...
Таким образом, $x \equiv 6 , (\text{mod} , 7)$ или $x = 6 + 7k$, где $k$ - любое целое число.
 ...
 <a id="item-2"></a>
## Теорема Эйлера
Теорема Эйлера — важное утверждение в области теории чисел. Давайте постараемся разобраться в ней простыми словами.

Итак, представьте, что у вас есть два числа: одно число (a) и ещё одно (n), причём между числом (a) и числом (n) нет общих делителей, кроме единицы. Например, (a = 3) и (n = 10). Теорема Эйлера говорит о том, какое значение будет у выражения (a) в какой-то степени, делённое на число (n).
...
Таким образом, Теорема Эйлера - это мощный инструмент в теории чисел, позволяющий делать выводы о свойствах чисел в определённых арифметических операциях.
